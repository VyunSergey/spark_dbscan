...
class PartitionIndexSuite extends SuiteBase with TestDatasets with DistanceCalculation  {
  ...
  test("PartitionIndex should correctly identify close points in all test datasets") {
    val allCases = Array(
      new TestCase (dataset00, 2.0),
      new TestCase (dataset01, 2.0),
      new TestCase (dataset10, 0.8),
      new TestCase (dataset11, 0.8),
      new TestCase (dataset20, 0.8),
      new TestCase (dataset30, 1)
    )
  ...
  test("PartitionIndex should put points into correct boxes") {
    ...
    val dbscanSettings = new DbscanSettings().withEpsilon(0.5)
    val points = Array(
      new Point(0.2, 0.2, 0.2), new Point(0.5, 0.5, 0.5),
  ...
  test("PartitionIndex should find adjacent boxes properly") {
    ...
    val points2D = Array(
      new Point(0.5, 0.5), new Point(1.5, 0.5),
      new Point(1.5, 1.5), new Point(3.5, 0.5),
    ...
    val points3D = Array(
      new Point(0.5, 0.5, 0.5), new Point(1.5, 0.5, 0.5),
      new Point(1.5, 1.5, 1.5), new Point(3.5, 0.5, 0.5),
